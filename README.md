...
## Team Members
- Zainab Irfan — backend development, LLM chat integration, data profiling, testing
- Sohana Pardeep — frontend development, dashboard charts, filters, documentation
